...
public class PanelTest {
	...
	public void panel1() throws IllegalArgumentException, IllegalAccessException {
		Panel.panel(5, 1);
	}

	@Test
	public void panelSizes() throws IllegalAccessException {
	...
	@Test
	public void panelIterator() throws IllegalAccessException {
	...
	@Test
	public void panelIterator2() throws IllegalAccessException {
		Random random = new Random();
		for (int i = 0; i < 1000; i++) {
			int start = random.nextInt();
	...
	public void panelIteratorNSEE() throws IllegalAccessException {
	...
	@Test
	public void panelRandomList() throws IllegalAccessException {
